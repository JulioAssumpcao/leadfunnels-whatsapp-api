...
/*
 * NOVA ROTA
 * GET /instances/:instanceId/groups/info?groupId=xxxx@g.us
 */
router.get("/instances/:instanceId/groups/info", async (req, res) => {
  ...
  try {
    ...
    const metadata =
      await session.sock.groupMetadata(groupId);
